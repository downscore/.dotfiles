...
--- Variable
--- Number of entries each line of helper.
obj.helperEntryEachLine = 5

--- RecursiveBinder.helperEntryLengthInChar
--- Variable
--- Length of each entry in char.
...
obj.helperFormat = {
  ...
  textFont = "MesloLGL Nerd Font",
  textSize = 20,
  -- Disable animation so the keybindings can be used more quickly.
  fadeInDuration = 0,
  fadeOutDuration = 0,
}
...
--- Variable
--- whether to show helper, can be true or false
...
local function showHelper(keyFuncNameTable)
  ...
  -- Extract keys from the table and sort in case-insensitive order.
  local keys = {}
